...
const LatestTvSeires = () => {
    ...
    const limit = 8;
    const [categoryWiseMedia, totalPages, categoryWiseMediaLoading] = useCategoryMedia("Latest Tv Seires", page, limit);
        ...
        <>
            <div className="bg-[#0C0C0C] text-white min-h-screen flex flex-col">
                <div className="my-20 px-10">
                    <button className="bg-green-500 px-10 py-1.5 rounded mt-10">Latest Tv Seires</button>
